	...
	<div class="products">	 
		<div class="container">
			<div class="col-md-9 product-w3ls-right"> 
				...
				<c:forEach items="${v2 }" var="dish2">
				  
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front"> 
									<img src="images/${dish2.photopath }" class="img-responsive" alt="img">
									<div class="agile-product-text">              
										<h5>${dish2.dishname }</h5>  
									</div> 
								</div>
								<div class="back">
									<h4>${dish2.dishname }</h4>
									<p>${dish2.dishinformation }</p>
									<h6>${dish2.prefer_price }<sup>￥</sup></h6>
									<form action="dishfindServlet" method="post">
										<input type="hidden" name="cmd" value="_cart">
										<input type="hidden" name="add" value="1"> 
										<input type="hidden" name="w3ls_item" value="${dish2.dishname }"> 
										<input type="hidden" name="amount" value="${dish2.prefer_price }"> 
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<div class="galry-like">  
						<a href="#" data-toggle="modal" data-target="#myModal1"><img src="images/t33.jpg" class="img-responsive" alt="img"></a>         
					</div>
				</div>
			</div>
			<div class="clearfix"> </div> 
					...
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right single-top-right"> 
							...
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart" />
								<input type="hidden" name="add" value="1" /> 
								<input type="hidden" name="w3ls_item" value="杏仁蛋糕" /> 
