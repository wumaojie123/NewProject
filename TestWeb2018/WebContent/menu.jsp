...
<body> 
	...
	<div class="wthree-menu">  
		...
		<div class="container">
			<h3 class="w3ls-title">菜单</h3>
			<div class="w3l-title-next">
				 <form action="dishfindServlet">
					 <label>特色小吃</label> <input type="radio" name="food" value="1"/>&nbsp&nbsp&nbsp
					 <label>主食</label> <input type="radio" name="food"  checked="checked" value="2" "/>&nbsp&nbsp&nbsp
					 <label>精品甜品</label> <input type="radio" name="food" value="3"/>&nbsp&nbsp&nbsp
					 <input type="submit" value="确定" />
				 </form>
			</div>
			<div class="menu-agileinfo">
			<c:forEach items="${v1 }" var="dish">
			<div class="col-md-4 col-sm-4 col-xs-6 menu-w3lsgrids"> 
					<a href="products.jsp"> ${dish.dishname }</a>
					</div>
			</c:forEach>
			</div>
