    ...
    <div class="nav-navicon admin-main admin-sidebar">
        ...
        <div class="sideMenu">
            ...
            <ul>
                ...
                <li><a href="inserUser.jsp">添加用户</a></li>
            </ul>           
...
<div class="admin-biaogelist">
    ...
    <form class="am-form am-g" action="updateUserServlet">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
           ...
           // System.out.println(_dishid);
            ...
            vuser=(Vector<UsertableDTO>)session.getAttribute("vuser");
            Iterator<UsertableDTO> it=vuser.iterator();
            ...
            %>
              ...
              <tr>
              <td>用户编号</td>  <td><input type="text" name="_userid" value=<%=userdto.getUserid() %>></td>
              </tr>
              <tr>
              <td>用户名</td>  <td><input type="text" name="_username" value=<%=userdto.getUsername() %>></td>
              </tr>
              <tr>
              <td>用户密码</td>  <td><input type="text" name="_userpass" value=<%=userdto.getUserpass() %>></td>
              </tr>
              <tr>
              <td>用户手机号</td>  <td><input type="text" name="_userphone" value=<%=userdto.getUserphone() %>></td>
              </tr>            
              <tr>
