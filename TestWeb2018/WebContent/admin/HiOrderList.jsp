...
<div class="admin-biaogelist">
    ...
    <form class="am-form am-g">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <tbody>
            <c:forEach items="${vorder_2}" var="order2">
            
              <tr>
                <td>${order2.orderid }</td>
                <td>${order2.userid }</td>
                <td>${order2.dishid}</td>
                <td>${order2.buynumber }</td> 
                <td>${order2.sumprice }</td>
                <td>${order2.ordertime }</td>  
                <td>${order2.createdate }</td>           
                <td class="am-hide-sm-only">${order2.orderstatus}</td>
                <td><div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                    
                        <a href="updateHiOrder?orderid=${order2.orderid }" class="am-btn am-btn-default am-btn-xs am-text-success am-round">确认订单</a>
                         <!-- 
