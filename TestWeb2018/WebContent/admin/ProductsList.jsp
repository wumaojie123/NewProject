...
<div class="admin-biaogelist">
    ...
    <form class="am-form am-g">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                ...
                <td class="table-type">原价</td>
                <td class="table-type">优惠价</td>
                <td class="table-author am-hide-sm-only">简介 </td>
                <td class="table-title">菜系</td>
            ...
            <c:forEach items="${listss}" var="person">           
              <tr>
                ...
                <td class="am-hide-sm-only">${person.dishinformation }</td>
                <td class="am-hide-sm-only">${person.deptsno }</td>
                <td><div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="updateDish.jsp?dishid=${person.dishid }" class="am-btn am-btn-default am-btn-xs am-text-success am-round">更新</a>
                        <a href="deleteDish?dishid=${person.dishid }" class="am-btn am-btn-default am-btn-xs am-text-danger am-round">删除</a>
                    </div>
                  </div></td>
              </tr>
              </c:forEach>
          ...
          <div class="_di_v">
<c:if test="${pageNos>1 }">
<a href="ddminFindDishServlet?pageNos=1" >首页</a>
<a href="ddminFindDishServlet?pageNos=${pageNos-1 }">上一页</a>
</c:if>
<c:if test="${pageNos <recordCount }">
<a href="ddminFindDishServlet?pageNos=${pageNos+1 }">下一页</a>
<a href="ddminFindDishServlet?pageNos=${recordCount }">末页</a>
</c:if>
<form action="adminFindDishServlet">
<h3 align="center">共${recordCount}页  </h3>
<input type="text" value="${pageNos}" name="pageNos" size="1" id="_simleinput">页
