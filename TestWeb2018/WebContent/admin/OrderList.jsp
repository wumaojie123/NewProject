    ...
    <div class="nav-navicon admin-main admin-sidebar">
        ...
        <div class="sideMenu">
            ...
            <ul>
                ...
                <li><a href="adminFindUserServlet">添加订单</a></li>
            </ul>
...
<div class="admin-biaogelist">
    ...
    <form class="am-form am-g">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <tbody>
            <c:forEach items="${vorder}" var="order">
              ...
              <tr>
                ...
                <td><div class="am-btn-toolbar">
                    ...
                    <!--  
                        <a href="updateOrder.jsp?orderid=${order.orderid }" class="am-btn am-btn-default am-btn-xs am-text-success am-round">更新</a>
                        -->
                        <a href="deleteOrder?orderid=${order.orderid}" class="am-btn am-btn-default am-btn-xs am-text-danger am-round">删除</a>
                    </div>
                  </div></td>
              </tr>
              </c:forEach>
