...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">添加餐位</a></dl>

    </div>
    <form class="am-form am-g" action="insertDeskServlet" name="formofdesk">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            
            <tbody>                   
              <tr>
              <td>餐位号</td>  <td><input type="text" name="_deskid" ></td>
              </tr>
              <tr>
              <td>座位数</td>  <td><input type="text" name="_seatnumber" ></td>
              </tr>
              <tr>
              <td>所属房间</td>  <td><input type="text" name="_roomid" ></td>
              </tr>                                    
               <tr>
              <td>操作</td>  <td><input type="submit" name="确认" onclick="return verify()"  value="添加"></td>
              </tr>         
            </tbody>
  ...
  <script type="text/javascript">
		function verify()
		{
			var str1=document.formofdesk._deskid.value;
			var str2=document.formofdesk._seatnumber.value;
			var str3=document.formofdesk._roomid.value;			
			if(str1=="")
				{
				alert("请输入餐桌号！");
				document.formofdesk._deskid.focus();
				return false;
				}
			if(str2=="")
			{
				alert("请输入座位数！");
				document.formofdesk._seatnumber.focus();
				return false;
				}
			if(str3=="")
			{
				alert("请输入所属房间号！");
				document.formofdesk._roomid.focus();
				return false;
				}			
		}
		</script>       
