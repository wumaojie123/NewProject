...
<div class="admin-biaogelist">
    ...
    <form class="am-form am-g">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                <td class="table-id">餐位号</td>
                <td class="table-title">座位数</td>
                <td class="table-type">所属房间</td>
                <td class="table-type">预定用户</td>                
                <td class="table-title">状态</td>
                <td width="163px" class="table-set">操作</td>
              </tr>
            </thead>
            <tbody>
            <c:forEach items="${vdesk}" var="person1">
            
              <tr>
                <td>${person1.deskid }</td>
                <td>${person1.seatnumber }</td>
                <td>${person1.roomid}</td>
                <td>${person1.userid }</td>              
                <td class="am-hide-sm-only">${person1.deskstatus}</td>
                <td><div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="updateDesk.jsp?deskid=${person1.deskid }" class="am-btn am-btn-default am-btn-xs am-text-success am-round">更新</a>
                        <a href="deleteDesk?deskid=${person1.deskid }" class="am-btn am-btn-default am-btn-xs am-text-danger am-round">删除</a>
                    </div>
                  </div></td>
              </tr>
              </c:forEach>
