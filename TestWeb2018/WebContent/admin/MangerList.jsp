          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                ...
                <td class="table-title">管理员名</td>
                <td class="table-type">管理员密码</td>
                <td class="table-type">管理员手机</td>                
                <td class="table-title">性别</td>
                <td width="163px" class="table-set">操作</td>
              </tr>
            </thead>
            <tbody>
            <c:forEach items="${vmanger}" var="manger">
            
              <tr>
                <td>${manger.userid }</td>
                <td>${manger.username }</td>
                <td>${manger.userpass}</td>
                <td>${manger.userphone }</td>              
                <td class="am-hide-sm-only">${manger.usersex}</td>
                <td><div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="updateManger.jsp?userid=${manger.userid }" class="am-btn am-btn-default am-btn-xs am-text-success am-round">更新</a>
