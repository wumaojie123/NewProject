...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">添加管理员列表</a></dl>

    </div>
    <form class="am-form am-g" action="insertMangerServlet">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            
            <tbody>
              <tr>
              <td>管理员名</td>  <td><input type="text" name="_username" id="account"></td>
              </tr>
              <tr>
              <td>管理员密码</td>  <td><input type="password" name="_userpass" id="pwd"></td>
              </tr>
              <tr>
              <td>管理员手机号</td>  <td><input type="text" name="_userphone" id="phone"></td>
              </tr>            
              <tr>
