...
<div class="admin-biaogelist">
    ...
    <form class="am-form am-g">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                <td class="table-id">用户编号</td>
                <td class="table-title">用户名</td>
                <td class="table-type">用户密码</td>
                <td class="table-type">用户手机</td>                
                <td class="table-title">性别</td>
                <td width="163px" class="table-set">操作</td>
              </tr>
            </thead>
            <tbody>
            <c:forEach items="${vuser}" var="user">
              ...
              <tr>
                ...
                <td class="am-hide-sm-only">${user.usersex}</td>
                <td><div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="updateUser.jsp?userid=${user.userid }" class="am-btn am-btn-default am-btn-xs am-text-success am-round">更新</a>
                        <a href="deleteUser?userid=${user.userid }" class="am-btn am-btn-default am-btn-xs am-text-danger am-round">删除</a>
                    </div>
                  </div></td>
              </tr>
              </c:forEach>
